...
function buildBuildCard(build,idx){
  ...
  var skillHtml=buildBuildSkillPreview(build._skillIcons||[]);
  var tag="";
...
function openBuildDetail(buildId){
  ...
  if(simTab){
    simTab.click();
    setTimeout(function(){ if(typeof simLoadBuild==='function') simLoadBuild(build,detail); },300);
  }
}
...
function showBuildDetail(build,detail){
  ...
  html+="</div></div>";
  var skills=(detail&&detail.skillIcons)||build._skillIcons||[];
